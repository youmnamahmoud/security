...
{2, 1, 14, 7, 4, 10, 8, 13, 15, 12, 9, 0, 3, 5, 6, 11},
   ...
   string s1bin,s2bin,s3bin,s4bin,s5bin,s6bin,s7bin,s8bin;
        s1bin=inputbin.substr(0,6);
        s2bin=inputbin.substr(6,6);
        s3bin=inputbin.substr(12,6);
        s4bin=inputbin.substr(18,6);
        s5bin=inputbin.substr(24,6);
        s6bin=inputbin.substr(30,6);
        s7bin=inputbin.substr(36,6);
        s8bin=inputbin.substr(42,6);
        ...
        for (int i=0;i<outputhexa.length();i++){
                outputhexa[i]=toupper(outputhexa[i]);
            }
                    cout<<outputhexa;
